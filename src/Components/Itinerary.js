...
useEffect(() => {
  ...
  <svg className='my-3' xmlns="http://www.w3.org/2000/svg" style={{color:'white'}}  width="50" height="50" fill="currentColor" class="bi bi-chevron-compact-down" viewBox="0 0 16 16">
