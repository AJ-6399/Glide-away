...
export default function Home() {
  return (
    <div>
      <>
      <div id="carouselExampleSlidesOnly" className="carousel slide" data-ride="carousel" data-interval="500" ride="false">
  <div className="carousel-inner">
    <div className="carousel-item active">
      <img style={{filter:'brightness(45%)'}} className="d-block" width="1530" height="735" src="https://media.cntraveler.com/photos/615f55a8eb6bd1314aa47add/16:9/w_2560%2Cc_limit/Outdoor%2520Enthusiasts-2021_GettyImages-451932111.jpg" alt="First slide"/>
